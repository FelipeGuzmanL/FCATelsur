...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('FCA Telsur') }}</title>
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('material') }}/img/logo_gtd.png">
    <link rel="icon" type="image/png" href="{{ asset('material') }}/img/logo_gtd.png">
    ...
    <body class="{{ $class ?? '' }}">
        @auth()
            <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">c
                @csrf
            </form>
