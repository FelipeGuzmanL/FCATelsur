                                ...
                                <div class="card-header card-header-primary">
                                    ...
                                    <div class="row">
                                        <div class="col-7 text-right d-felx">
                                            <form action="{{route('mantenciones.index_msan_mantencion', [$equipo])}}" method="get">
                                                <div class="form-row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-right">
                                            <a href="{{ route('mantenciones.create'), $equipo->id}}" class="btn btn-primary">Crear Mantención</a>
                                        </div>
                                    </div>
