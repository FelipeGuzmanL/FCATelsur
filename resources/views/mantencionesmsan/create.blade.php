                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="fecha_mantencion" required oninvalid="this.setCustomValidity('Ingrese fecha de la mantención')" oninput="this.setCustomValidity('')"/>
                                </div>
                            </div>
                            <br>
                            <div class="row">
