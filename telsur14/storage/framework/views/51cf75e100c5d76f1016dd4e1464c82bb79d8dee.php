                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-tittle">Lista de Cables de Fibra Óptica de <?php echo e($sitio->nombre); ?></h4>
                                    <div class="row">
                                        <div class="col-7 text-right d-felx">
                                            <form action="<?php echo e(route('sitios.index_cable', $sitio)); ?>" method="get">
                                                <div class="form-row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <?php if($sitio->id == $cable->sitio->id): ?>
                                                <?php if($cable->id > "1"): ?>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'cable', 'titlePage' => 'Lista de Cables de Fibra'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\feli_\BitacorasVehiculosTelsur\resources\views/sitios/index_cable.blade.php ENDPATH**/ ?>