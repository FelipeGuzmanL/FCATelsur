<div class="sidebar" data-color="orange" data-background-color="white" data-image="<?php echo e(asset('material')); ?>/img/sidebar-1.jpg">
  ...
  <div class="sidebar-wrapper">
    <ul class="nav">
      ...
      <li class="nav-item<?php echo e($activePage == 'sitios' ? ' active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route('sitios.index')); ?>">
          <i class="material-icons">location_on</i>
            <p><?php echo e(__('Lista de Sitios')); ?></p>
        </a>
      </li>
      <li class="nav-item<?php echo e($activePage == 'cable' ? ' active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route('cable.index')); ?>">
          <i class="material-icons">cable</i>
            <p><?php echo e(__('Cables')); ?></p>
        </a>
      </li>
      <li class="nav-item<?php echo e($activePage == 'equiposmsan' ? ' active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route('equiposmsan.index')); ?>">
          <i class="material-icons">dns</i>
            <p><?php echo e(__('Equipos MSAN')); ?></p>
        </a>
      </li>
...
<?php /**PATH C:\Users\feli_\BitacorasVehiculosTelsur\resources\views/layouts/navbars/sidebar.blade.php ENDPATH**/ ?>