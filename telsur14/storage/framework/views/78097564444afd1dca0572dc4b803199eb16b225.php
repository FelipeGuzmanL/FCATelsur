      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
            <a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>"><?php echo e(__('Perfil')); ?></a>
            <a class="dropdown-item" href="#"><?php echo e(__('Configuraciones')); ?></a>
...
<?php /**PATH C:\Users\feli_\BitacorasVehiculosTelsur\resources\views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>