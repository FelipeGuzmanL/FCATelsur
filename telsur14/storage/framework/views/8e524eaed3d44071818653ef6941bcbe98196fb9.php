...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="<?php echo e(route('equiposmsan.slots.olt.store', [$equipo,$slot])); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-tittle">Guardar OLT <?php echo e($slot->slot_msan); ?></h4>
                        ...
                        <div class="card-body">
                            ...
                            <!--div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="olt" placeholder="Numero OLT" value="<?php echo e(old('olt')); ?>" required oninvalid="this.setCustomValidity('Ingrese el numero OLT')" oninput="this.setCustomValidity('')">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        ...
                                        <?php $__currentLoopData = $cables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($cable->id == "1"): ?>
                                                <option value="<?php echo e($cable->id); ?>"><?php echo e($cable->nombre_cable); ?></option>
                                            <?php elseif($cable->id > "1"): ?>
                                                <option value="<?php echo e($cable->id); ?>"><?php echo e($cable->nombre_cable); ?> - <?php echo e($cable->sitio->abreviacion); ?></option>
                                            <?php endif; ?>
                            ...
                            <!--div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="filam" placeholder="Filamento" value="<?php echo e(old('filam')); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="spl" placeholder="Spliter" value="<?php echo e(old('spl')); ?>">
                            ...
                            <label for="sitio_fca" class="col-sm-2 col-form-label">Sitio FCA</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="sitio_fca" placeholder="Sitio FCA" value="<?php echo e(old('sitio_fca')); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="descripcion_fca" placeholder="Descripción sitio FCA" value="<?php echo e(old('descripcion_fca')); ?>">
...
<?php echo $__env->make('layouts.app', ['activePage' => 'equiposmsan', 'titlePage' => 'Guardar Equipo MSAN'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\feli_\BitacorasVehiculosTelsur\resources\views/olt/create.blade.php ENDPATH**/ ?>