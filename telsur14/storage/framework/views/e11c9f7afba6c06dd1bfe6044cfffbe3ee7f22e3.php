...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="<?php echo e(route('equiposmsan.update', $equipos->id)); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-tittle">MSAN <?php echo e($equipos->numero); ?></h4>
                        ...
                        <div class="card-body">
                            ...
                            <label for="numero" class="col-sm-2 col-form-label">Numero MSAN</label>
                                <div class="col-sm-7">
                                    <input type="number" class="form-control" name="numero" placeholder="Numero MSAN" value="<?php echo e(old('numero', $equipos->numero)); ?>" autofocus required oninvalid="this.setCustomValidity('Ingrese Numero del MSAN')" oninput="this.setCustomValidity('')"/>
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        ...
                                        <?php $__currentLoopData = $tecnologias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tecnologia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($tecnologia->id); ?>" <?php echo e($equipos->tecnologia->id == $tecnologia->id ? 'selected' : ''); ?>><?php echo e($tecnologia->nombre_tec); ?></option>
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        ...
                                        <?php $__currentLoopData = $slotstec; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slotec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($slotec->id); ?>" <?php echo e($equipos->slotec->id == $slotec->id ? 'selected' : ''); ?>><?php echo e($slotec->slots); ?> - <?php echo e($slotec->tecnologia->nombre_tec); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                      </div>
                                </div>
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        ...
                                        <?php $__currentLoopData = $sitio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sitio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sitio->id); ?>" <?php echo e($equipos->Ubicacion->ciudad->id == $sitio->id ? 'selected' : ''); ?>><?php echo e($sitio->nombre); ?> - <?php echo e($sitio->abreviacion); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                      </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="direccion" placeholder="Ingrese dirección" value="<?php echo e(old('direccion', $equipos->Ubicacion->direccion)); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="link_gmaps" placeholder="Link a Google Maps" value="<?php echo e(old('link_gmaps', $equipos->Ubicacion->link_gmaps)); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="sitio_fca" placeholder="Ingrese Sitio FCA" value="<?php echo e(old('sitio_fca', $equipos->Ubicacion->sitio_fca)); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="descripcion_sitio" placeholder="Descripción" value="<?php echo e(old('descripcion_sitio', $equipos->Ubicacion->descripcion_sitio)); ?>">
...
<?php echo $__env->make('layouts.app', ['activePage' => 'equiposmsan', 'titlePage' => 'Editar Equipo MSAN'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\feli_\BitacorasVehiculosTelsur\resources\views/equiposmsan/edit.blade.php ENDPATH**/ ?>